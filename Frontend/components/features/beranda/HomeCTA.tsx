    ...
    <section className="py-16 bg-gradient-to-r from-primary-900 via-primary-800 to-secondary-950 text-white relative overflow-hidden on-dark">
      ...
      <div className="container-desa relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
        <div className="space-y-3 max-w-2xl text-center lg:text-left">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-accent-500/20 text-accent-400 border border-accent-500/30 text-xs font-bold">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 shrink-0">
          <Link href="/pengaduan">
            <Button variant="accent" size="lg" className="font-extrabold shadow-xl text-neutral-950">
